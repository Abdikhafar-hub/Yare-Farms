  ...
  return (
    <div className="relative h-screen overflow-hidden z-10">
      ...
      <button 
        ...
        className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-gray-700 p-2 rounded-full text-white hover:bg-gray-900 transition z-10"
      >
        <FaArrowLeft size={16} />
      </button>
      ...
      <button 
        ...
        className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-gray-700 p-2 rounded-full text-white hover:bg-gray-900 transition z-10"
      >
